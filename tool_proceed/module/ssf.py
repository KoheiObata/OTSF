# ssf.py: シンプルなスケール・シフト適応層とそのユーティリティ
...
def add_ssf_(parent_module: nn.Module, module_name: str, freeze_weight: bool,
    ...
    """
    指定した親モジュールのサブモジュール(module_name)をSSF適応層に置き換える。
    - Linear/Conv1D/LayerNormなど多様な層に対応。
