...
do
  headpath=./results/$border_type/$model_name'_RevIN'/$data/$seq_len'_'$pred_len
  checkpoints=$headpath/'Offline/lr'$learning_rate'_'$optim'_'$batch_size
  modelpath='pretrain_'$online_method'/lr'$learning_rate'_'$optim'_'$batch_size'/olr'$online_learning_rate'_'$optim
