...
do
  filename=logs/online/$model_name'_dc'$decomposition'_'$online_method'_'$data'_'$pred_len'_onlinelr'$online_learning_rate.log
  save_filename=checkpoints/$online_method'_dc'$decomposition'_'$data'_'$pred_len
  python -u run.py \
