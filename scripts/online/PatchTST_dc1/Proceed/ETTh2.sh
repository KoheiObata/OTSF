...
do
  ...
  filename=logs/online/$model_name'_dc'$decomposition'_'$online_method'_mid'$mid'_share_fulltune_'$tune_mode'_'$data'_'$pred_len'_btl'$btl$suffix.log
  python -u run.py \
